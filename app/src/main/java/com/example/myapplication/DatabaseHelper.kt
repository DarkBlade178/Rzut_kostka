...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val CREATE_TABLE = "CREATE TABLE $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY, $COLUMN_PLAYER TEXT, $COLUMN_SCORE INTEGER, $COLUMN_TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP)"
    }
}
